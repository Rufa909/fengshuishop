...
document.addEventListener("DOMContentLoaded", function () {
    const jewellery_lite_progressBar =
        document.getElementById("jewellery_lite_elemento_progress_bar");
    if (!jewellery_lite_progressBar) return;
    window.addEventListener("scroll", function () {
        const jewellery_lite_scrollTop =
            document.documentElement.scrollTop || document.body.scrollTop;
        const jewellery_lite_height =
            document.documentElement.scrollHeight -
            document.documentElement.clientHeight;
        const jewellery_lite_scrolled =
            (jewellery_lite_scrollTop / jewellery_lite_height) * 100;
        jewellery_lite_progressBar.style.width =
            jewellery_lite_scrolled + "%";
    });
});
        ...
        <div class="entry-attachment">
            ...
            <?php if ( has_excerpt() ) : ?>
                <div class="entry-caption">
                    <div class="entry-content"><p><?php $jewellery_lite_excerpt = get_the_excerpt(); echo esc_html( jewellery_lite_string_limit_words( $jewellery_lite_excerpt, esc_attr(get_theme_mod('jewellery_lite_excerpt_number','30')))); ?></p></div>
                </div>
            <?php endif; ?>
        </div>    
        <?php
